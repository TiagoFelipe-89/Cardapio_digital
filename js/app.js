...
var CELULAR_EMPRESA = "5581997554292";
...
cardapio.metodos = {
    ...
    obterItensCardapio: (categoria = 'burgers', vermais = false) => {
        ...
        $.each(filtro, (i, e) => {
            ...
            let temp = cardapio.templates.item
                ...
                .replace(/\${preco}/g, e.price.toFixed(2).replace('.', ',')).replace(/\${id}/g, e.id)

            // botão ver mais que foi clicado (12 itens)
            if (vermais && i >= 8 && i < 12) {
                $("#itensCardapio").append(temp)

            }
            // paginação inicial OU SEJA (8 intens)
            if (!vermais && i < 8) {
                $("#itensCardapio").append(temp)
            }
        ...
        // ----- metodos que não funcionaram para selecionar o icone e ficar 
        // remove o ativo
    ...
    adicionarAoCarrinho: (id) => {
        ...
        if (qntAtual > 0) {
            ...
            if (item.length > 0) {
                ...
                cardapio.metodos.mensagem('Item adicionado ao carrino!', 'green');
                $("#qntd-" + id).text(0);
    ...
    // atualizar badge de totais dos botões "Meu carinho"
    atualizarBadgeTotal: () => {
    ...
    //carrega os valores de subtotal e entrega o total
    carregarValores: () => {
        VALOR_CARRINHO = 0;
    ...
    finalizarPedido: () => {
        if (MEU_CARRINHO.length > 0 && MEU_ENDERECO != null){
            ...
            // hhtps://wa.me/5581997554292?text?Olá
        }
    },
    ...
    carregarBotaoWhatsapp: () => {
        var texto = 'Olá! gostaria de saber sobre o *whatsapp* de vocês!';
...
cardapio.templates = {
        ...
        <div class="col-12 col-lg-3 col-md-3 col-sm-6 mb-5 animated fadeInUp">
            <div class="card card-item" id="\${id}">
                ...
                <div class="add-carrinho">
                    ...
                    <span class="add-menu-itens" id="qntd-\${id}">0</span>
    ...
    <div class="col-12 item-carrinho">
        ...
        <div class="add-carrinho">
            ...
            <span class="add-menu-itens" id="qntd-carrinho-\${id}">\${qntd}</span>
